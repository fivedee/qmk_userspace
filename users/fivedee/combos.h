...
const uint16_t PROGMEM combo_MDA[] ={LT(_NAV, KC_SPC), KC_TAB, COMBO_END};
const uint16_t PROGMEM combo_FUN[] ={LT(_NUM, KC_BSPC), KC_ENT, COMBO_END};
// const uint16_t PROGMEM combo_ADB[] ={KC_TAB, KC_ENT, COMBO_END};
